...
export const metadata = {
  title: "Advertise With Us - SuccessWikis",
  description: "It's time for a new kind of advertising for the internet. Start advertising with SuccessWikis and align your brand with premium storytelling.",
};
    ...
    <div className="ads-page">
      <div className="ads-container">
        ...
        <div className="ads-image-card">
          <Image src={adsHeroImg} alt="Advertising Diagram 1" priority />
        </div>
        ...
        <div className="ads-image-card">
          <Image src={adsProblemImg} alt="The Problem Diagram" />
        </div>
        <p
          className="para-text"
          style={{
        ...
        <div className="ads-image-card">
          <Image src={adsSolutionImg} alt="The Solution Diagram" />
        </div>
        <p
          className="para-text"
          style={{
