...
export const metadata = {
  title: "Cookies Policy - SuccessWikis",
  description: "Learn about how SuccessWikis uses cookies, web beacons, and local storage to enhance your browsing experience.",
};
