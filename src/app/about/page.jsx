...
export const metadata = {
  title: "About Us - SuccessWikis",
  description: "SuccessWikis began with a simple belief: the most powerful stories in entrepreneurship are often the ones left untold. Read our story and beliefs.",
};
        ...
        <>
            ...
            <section className="our-story-about-page">
             ...
             <section className="about-split-section">
                <div className="split-abs-container">
                    <Image src={groupImg} alt="Group" className="abs-group-img" priority />
                </div>
                ...
                <div className="split-right">
                    <div className="vector-abs-container">
                        <Image src={vectorImg} alt="Vector" className="abs-vector-img" />
                    </div>
                    <div className="split-content">
            ...
            <section className="advertise-idea-section">
                ...
                <div className="ad-cta-container">
                    <Link href="/contact" className="contact-pill-btn" >Contact US</Link>
                </div>
            </section>
        </>
    );
