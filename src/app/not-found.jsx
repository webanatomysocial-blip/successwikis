...
export const metadata = {
  title: "Page Not Found - SuccessWikis",
};

const NotFound = () => {
  return (
    <div className="not-found-container" style={{ padding: "100px 20px" }}>
      <div className="not-found-content">
        ...
        <div className="not-found-text">
          ...
          <Link href="/" className="black-bg-btn" style={{ margin: '0 auto' , marginTop: '20px' }}>
            Go to Home Page
          </Link>
        </div>
      </div>
