...
export const metadata = {
  title: "Accessibility Statement - SuccessWikis",
  description: "SuccessWikis is committed to digital accessibility. Read our statement and find out how we support assistive technologies.",
};
