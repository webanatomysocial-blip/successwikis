...
import sampleImage from '../../assets/The-stage-behind-the-story/The-Soldier.jpeg'; 
import sponsoredImage from '../../assets/Sponsored/sponsored-image.jpg';

const SoldierRewiredPost = ({ dynamicRecentPosts, postId }) => {
    const content = (
        <>
            <h2>From the Army to AI: The Man Rebuilding India’s Classrooms</h2>
            <p>
            ...
            <blockquote className="pod-quote">
                “Why are our children being raised on screens, not systems? On games, not growth?”
            </blockquote>
            ...
            <blockquote className="pod-quote">
                He stated that “Rather than pick up another job, we wanted to pick up a purpose.”
            </blockquote>
            ...
            <h2>The Struggle Behind the Vision</h2>
            <p>
            ...
            <blockquote className="pod-quote">
                “The business tested me. And once I passed that test, doors slowly began to open.”
            </blockquote>
            
            <p>
                That test of spirit, not strategy, became the foundation for what followed.
            </p>

            <h2>When Everyone Else Laughed, He Built</h2>
            <p>
            ...
            <p>
                He pushed, while others doubted.<br/>
                He innovated, while others waited.<br/>
                He built slow, honest, bootstrapped growth.
            </p>

            <blockquote className="pod-quote">
                He says “You don’t need investors. Just discipline. Put your shoulder to the wheel every day even when it’s boring and especially when it’s boring.”
            </blockquote>
            
            <p>
                For him, business is less about business and more about service. That mindset came from the army and stayed.
            </p>

            <h2>Rewiring Education, One Kit at a Time</h2>
            <p>
            ...
            <h2>A Line That Says It All</h2>
            <p>
                And if there’s one thing he hopes you remember from his story, it’s this:
            </p>
             <blockquote className="pod-quote">
                “Jo thehr gaya, so dhoop gaya. Jo doobh gaya, woh phaad gaya.”
            </blockquote>
            <p>
                (“If you hesitate, you fade. But if you fully immerse yourself, you break through.”)
            </p>
            <p>
                He’s lived that line from a modest childhood to national service and now, to rewriting what learning means for thousands of children across India.
            </p>

            <h2>Success, as Seen in an Orphanage</h2>
            <p>
            ...
            <blockquote className="pod-quote">
                He says “When those girls explain to me what a potentiometer is… when they teach me how a sensor works… that’s what success looks like.”
            </blockquote>
            <p>
                Not quarterly growth. Not scale. Impact. Empowerment. Dignity. That’s the metric he tracks.
            </p>

            <h2>Why We’re Telling This Story</h2>
            <p>
...
export default SoldierRewiredPost;
