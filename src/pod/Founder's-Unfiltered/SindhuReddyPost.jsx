...
import sampleImage from '../../assets/Founder\'s-Unfiltered/sindu.png'; 
import sponsoredImage from '../../assets/Sponsored/sponsored-image.jpg';

const SindhuReddyPost = ({ dynamicRecentPosts }) => {
    const content = (
        <>
            <h2>Can you tell me what your company does and what problem it solves?</h2>
            <p>
                At <strong>Zenith Energy</strong>, our mission is really quite simple: we help businesses use less energy, more intelligently. We’re an energy and sustainability consulting firm, but more than that, we’re problem solvers.
            </p>
            <p>
            ...
            <h2>What inspired you to start this journey? Was there a trigger or personal moment behind it?</h2>
            <p>
            ...
            <h2>Was there something you believed in that others didn’t? How did you handle that?</h2>
            <p>
            ...
            <h2>What’s one lesson you’d share with someone just starting out, especially if they’re building without investors or connections?</h2>
            <p>
